...
def batched_gather(data, inds, dim=0, no_batch_dims=0):
    ...
    # remaining_dims[0] = np.expand_dims(remaining_dims[0], axis=0)[:, :, :, None]
    ranges.extend(remaining_dims)   # (1,1,1) (1,4,1) (1,4,37)
    return data[tuple(ranges)]         #data.shape = (1,4,14,3)
    # return data[ranges]
