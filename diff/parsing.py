...
def parse_train_args():
    ...
    group.add_argument('--relative_pos_emb', action='store_true')
    ...
    group.add_argument("--beta_schedule", type=str, default="polynomial_2", choices=["linear", "quadratic", "polynomial_2",  "polynomial_n", "cosine"])
    ...
    parser.add_argument('--decoder', type=str, default='mlp', help='')
    parser.add_argument('--dropout_p', type=int, default=0.1, help='')
    parser.add_argument('--position_embedding_type', type=str, default="relative", help='')
